...
let ProductSuggestions = class extends i {
  constructor() {
    super(...arguments);
    __publicField(this, "productId", "");
    __publicField(this, "productName", "");
    __publicField(this, "productDescription", "");
    __publicField(this, "suggestions", "[]");
    __publicField(this, "primaryColor", colors.blue[600]);
    __publicField(this, "header", "Ask AI Shopping Assistant");
    __publicField(this, "placeholder", "Ask something else...");
    __publicField(this, "customMessage", "");
  }
  // Parse suggestions on every render instead of in updated()
  ...
  dispatch(message) {
    ...
    const contextMessage = this.productDescription ? `[Product: ${this.productName}] ${this.productDescription}

Question: ${message.trim()}` : message.trim();
    window.dispatchEvent(
      new CustomEvent("bf:open-chat", {
        detail: {
  ...
  handleInputChange(e2) {
    this.customMessage = e2.target.value;
  }
  handleInputKeyDown(e2) {
    if (e2.key === "Enter" && this.customMessage.trim()) {
      e2.preventDefault();
      this.dispatch(this.customMessage);
      this.customMessage = "";
    }
  }
  handleSendClick() {
  ...
  render() {
    ...
    const suggestions = this.parsedSuggestions;
    return b`
      <p class="header" style="color: ${primary};">
        ${this.header}
      </p>
      ...
      (s2) => b`
              <button
                ...
                style="color: ${primary};"
                @click=${() => this.handleSuggestionClick(s2)}
              >
      ...
      <div class="input-row">
        ...
        <button
          ...
          ?disabled=${!this.customMessage.trim()}
...
__publicField2(ProductSuggestions, "styles", i$3`
    :host {
      display: block;
  ...
  `);
__decorateClass([
  n2({ type: String, attribute: "product-id" })
], ProductSuggestions.prototype, "productId", 2);
__decorateClass([
  n2({ type: String, attribute: "product-name" })
], ProductSuggestions.prototype, "productName", 2);
__decorateClass([
  n2({ type: String, attribute: "product-description" })
], ProductSuggestions.prototype, "productDescription", 2);
__decorateClass([
  n2({ type: String })
], ProductSuggestions.prototype, "suggestions", 2);
__decorateClass([
  n2({ type: String, attribute: "primary-color" })
], ProductSuggestions.prototype, "primaryColor", 2);
__decorateClass([
  n2({ type: String })
], ProductSuggestions.prototype, "header", 2);
__decorateClass([
  n2({ type: String })
], ProductSuggestions.prototype, "placeholder", 2);
__decorateClass([
  r()
], ProductSuggestions.prototype, "customMessage", 2);
ProductSuggestions = __decorateClass([
  t("bf-product-suggestions")
], ProductSuggestions);
...
//# sourceMappingURL=product-suggestions.js.map
